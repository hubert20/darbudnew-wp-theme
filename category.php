...
/**
 * Szablon archiwum kategorii - uniwersalny dla wszystkich kategorii
 */
        ...
        <div class="row g-4">
            ...
            if (have_posts()) :
                while (have_posts()) : the_post();
                    // Sprawdź czy to jest post w kategorii "domy-mobilne"
                    $is_mobile_house = has_term('domy-mobilne', 'category');
                    if ($is_mobile_house) {
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="<?php echo esc_url(get_permalink()); ?>" class="mobile-house-card text-decoration-none d-block position-relative overflow-hidden" title="<?php echo esc_attr(get_the_title()); ?>">
                            ...
                            <div class="mobile-house-card__content p-3 bg-white border border-top-0">
                                ...
                                <?php if ($is_mobile_house && !empty($house_specs['powierzchnia'])) : ?>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-10 col-lg-3 d-grid">
                <a data-category="form-category-<?php echo esc_attr($category_slug); ?>" data-bs-toggle="modal" data-bs-target="#offerformModal" class="btn btn--style-2">
